...
const CampeonatoPage = () => {
    ...
    const selecionarPartida = (partida) => {
    ...
    return (
        <div>
                    ...
                    <div>
                        ...
                        <ul>
                            {fases[faseAtual].map((partida, index) => (
                                <li key={index}>
                                    <button onClick={() => selecionarPartida(partida)}>
            ...
            {partidaAtual && !emGrusht && (
                <Partida timeA={partidaAtual.timeA} timeB={partidaAtual.timeB} encerrarPartida={encerrarPartida} iniciarGrusht={iniciarGrusht} />
            )}
            {emGrusht && (
                <GrushtPage timeA={partidaAtual.timeA} timeB={partidaAtual.timeB} encerrarGrusht={encerrarGrusht} />
            )}
            {vencedorFinal && (
                <div>
